...
local arkhan_tmb_tomb_king_unlocks_techs = {
    ...
    ["tech_arkhan_lord_top_right"] = {forename = "names_name_159753854", surname = "", subtype = "arkhan_tmb_tomb_king_sacrament"},
    ["tech_arkhan_lord_extra_left_lord_unlock"] = {forename = "names_name_159753855", surname = "", subtype = "arkhan_tmb_tomb_king_madness"},
    ["tech_arkhan_lord_extra_right_lord_unlock"] = {forename = "names_name_159753856", surname = "", subtype = "arkhan_tmb_tomb_king_terror"}
};
...
local function STEPHEN_DynastyTree_ResearchCompleted(context)
    ...
    if faction:is_human() == true and faction:culture() == "wh2_dlc09_tmb_tomb_kings" then
            ...
            if tech_key:starts_with(arkhan_tmb_tomb_king_unlocks) then
                    ...
                    if lord ~= nil then
                            cm:spawn_character_to_pool(faction:name(), lord.forename, lord.surname, "", "", 18, true, "general", lord.subtype, true, "");
                    end
            end
    end
end
